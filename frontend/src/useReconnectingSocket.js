...
/**
 * Owns one WebSocket connection to a given URL, with automatic
 * reconnection.
 *
 ...
 *
 * Pass `url` as null/undefined to skip connecting (e.g. while some
 * prerequisite id isn't known yet).
 */
export function useReconnectingSocket(url, onMessage) {
